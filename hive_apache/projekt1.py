...
with DAG(
    ...
    params={
      "dags_home": Param("~/airflow/dags", type="string"),
      "input_dir": Param("gs://bucket-kk-23/project1/input", type="string"),
  ...
  mapreduce_classic = BashOperator(
    ...
    bash_command="""hadoop jar {{ params.dags_home }}/project_files/project1.jar {{ params.input_dir }}/datasource1 {{ params.output_mr_dir }}""",
  )
...
... """,
  ...
  hive = BashOperator(
    ...
    bash_command="""beeline -u jdbc:hive2://localhost:10000/default \
      -f {{ params.dags_home }}/project_files/transform9.hql \
